...
var NodeGraph = (function (_React$Component) {
	_inherits(NodeGraph, _React$Component);

	function NodeGraph(props) {
		_classCallCheck(this, NodeGraph);

		_get(Object.getPrototypeOf(NodeGraph.prototype), 'constructor', this).call(this, props);
			...
			return _react2['default'].createElement(
				...
				nodes.map(function (node) {
					return _react2['default'].createElement(_libNode2['default'], {
						...
						onNodeSelect: function (nid) {
							_this.handleNodeSelect(nid);
						},
						onNodeDeselect: function (nid) {
							_this.handleNodeDeselect(nid);
						}
					});
				}),
				_react2['default'].createElement(
					...
					connectors.map(function (connector) {
						...
						return _react2['default'].createElement(_libSpline2['default'], {
							...
							mousePos: mousePos,
							onRemove: function () {
								_this.handleRemoveConnector(connector);
							}
						});
					}),
					newConnector
